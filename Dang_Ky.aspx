<%@ Page Language="C#" MasterPageFile="~/Trangchu.master" AutoEventWireup="true" CodeFile="Dang_Ky.aspx.cs" Inherits="Dang_Ky" Title="Đăng Ký" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="TextBox4" runat="server" Width="173px"></asp:TextBox></td>
            ...
            <tr>
                <td align="right" style="width: 45%">
    <asp:Button ID="Button1" runat="server" BackColor="#C0C0FF" Font-Bold="True" ForeColor="Black"
        OnClick="Button1_Click" Text="Đăng Ký" /></td>
                <td style="width: 100px">
                </td>
                <td align="left" style="width: 50%">
